/**
 * api/_lib/email/templates.ts — V4 M9.A.3 customer-loop email templates.
 *
 * Four shared templates rendered as plain HTML strings. The send wrappers
 * (in api/_lib/email.ts + api/_lib/merchantEmails.ts) handle Resend transport,
 ...
 *
 * `api/_lib/email-templates.ts` (5 merchant lifecycle templates) STAYS as-is
